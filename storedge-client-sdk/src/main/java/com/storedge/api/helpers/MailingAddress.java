...
public class MailingAddress {
    ...
    public MailingAddress(String id, String address1, String address2, String city, String state, String postal, String country,
                          String full_address, double latitude, double longitude, String time_zone_id, String time_zone_offset,
                          boolean invalid_data, String label) {
        this.id = id;
